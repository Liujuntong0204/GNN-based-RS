...
item_emb_path = "/kaggle/working/item_embeddings.pt"
item_emb = torch.load(item_emb_path, map_location='cpu', weights_only=False)  
print("item_emb_shape", item_emb.shape)

user_emb_path = "/kaggle/working/user_embeddings.pt"
user_emb = torch.load(user_emb_path, map_location='cpu', weights_only=False)                # [num_users, emb_dim]
